...
export const metadata: Metadata = {
  title: "ハーネス設計",
  description: "マルチエージェント構成・記録・自走・安全設計をどう組んだかの設計面の概要",
    ...
    <div className="mx-auto max-w-5xl px-6 py-20">
      <div className="relative">
        ...
        <p className="text-muted-foreground mt-2">
          <JapaneseLineBreak text="マルチエージェント構成・記録・自走・安全設計をどう組んだかの設計面の概要です。" />
        </p>
      </div>

      <p className="text-muted-foreground mt-10 max-w-3xl text-base leading-8">
        <JapaneseLineBreak text="マルチエージェント構成・記録・自走・安全設計をどう組んだかの設計面をまとめています。" />
      </p>
